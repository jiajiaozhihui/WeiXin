...
{
	/// <summary>
	/// 数据访问类:DRP_Invite_Arts
	/// </summary>
	public partial class DRP_Invite_Arts:IDRP_Invite_Arts
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "DRP_Invite_Arts"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from DRP_Invite_Arts");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into DRP_Invite_Arts(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update DRP_Invite_Arts set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from DRP_Invite_Arts ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		public SfSoft.Model.DRP_Invite_Arts GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,Topic,KeyWord,ArtType,SendStatus,ArtContent,PubDate,Creator,OrderID,TurnNum,ClickNum,modifier,mtime from DRP_Invite_Arts ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			SfSoft.Model.DRP_Invite_Arts model=new SfSoft.Model.DRP_Invite_Arts();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM DRP_Invite_Arts ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from DRP_Invite_Arts T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "DRP_Invite_Arts";
