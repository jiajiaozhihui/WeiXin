...
namespace SfSoft.SQLServerDAL
{
    ...
    public class Pub_BaseData_Classc : IPub_BaseData_Classc
    {
        ...
        public int Add(SfSoft.Model.Pub_BaseData_Classc model)
        {
            ...
            strSql.Append("ClassID,ParentCID,ClassName,ClassType)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,ClassID,ParentCID,ClassName,ClassType from Pub_BaseData_Classc ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,ClassID,ParentCID,ClassName,ClassType ");
