...
{
	/// <summary>
	/// 数据访问类:DRP_Invite_My_Arts
	/// </summary>
	public partial class DRP_Invite_My_Arts:IDRP_Invite_My_Arts
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "DRP_Invite_My_Arts"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from DRP_Invite_My_Arts");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(SfSoft.Model.DRP_Invite_My_Arts model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into DRP_Invite_My_Arts(");
			strSql.Append("InviteID,DisID,Topic,KeyWord,ArtType,SendStatus,ArtContent,PubDate,Creator,IsSales,IsContact,IsJoin,TurnNum,ClickNum,modifier,mtime)");
			...
			parameters[10].Value = model.IsContact;
			parameters[11].Value = model.IsJoin;
			parameters[12].Value = model.TurnNum;
			parameters[13].Value = model.ClickNum;
			parameters[14].Value = model.modifier;
			parameters[15].Value = model.mtime;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SfSoft.Model.DRP_Invite_My_Arts model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update DRP_Invite_My_Arts set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from DRP_Invite_My_Arts ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SfSoft.Model.DRP_Invite_My_Arts GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,InviteID,DisID,Topic,KeyWord,ArtType,SendStatus,ArtContent,PubDate,Creator,IsSales,IsContact,IsJoin,TurnNum,ClickNum,modifier,mtime from DRP_Invite_My_Arts ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			SfSoft.Model.DRP_Invite_My_Arts model=new SfSoft.Model.DRP_Invite_My_Arts();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["IsJoin"]!=null && ds.Tables[0].Rows[0]["IsJoin"].ToString()!="")
				{
					model.IsJoin=int.Parse(ds.Tables[0].Rows[0]["IsJoin"].ToString());
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,InviteID,DisID,Topic,KeyWord,ArtType,SendStatus,ArtContent,PubDate,Creator,IsSales,IsContact,IsJoin,TurnNum,ClickNum,modifier,mtime ");
			strSql.Append(" FROM DRP_Invite_My_Arts ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,InviteID,DisID,Topic,KeyWord,ArtType,SendStatus,ArtContent,PubDate,Creator,IsSales,IsContact,IsJoin,TurnNum,ClickNum,modifier,mtime ");
			strSql.Append(" FROM DRP_Invite_My_Arts ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from DRP_Invite_My_Arts T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "DRP_Invite_My_Arts";
